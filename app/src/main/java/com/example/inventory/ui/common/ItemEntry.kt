...
fun ItemEntryBody(
    ...
    Column(
        ...
        Button(
            onClick = onSaveClick,
            enabled = itemUiState.itemDetails.isEntryValid,
...
fun ItemInputForm(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            modifier = Modifier.fillMaxWidth(),
            isError = !itemDetails.isSupplierNameValid && itemDetails.supplierName.isNotBlank(),
            enabled = enabled,
            singleLine = true
        )
        OutlinedTextField(
            ...
            modifier = Modifier.fillMaxWidth(),
            isError = !itemDetails.isSupplierPhoneValid && itemDetails.supplierPhone.isNotBlank(),
            enabled = enabled,
            singleLine = true
        )
        OutlinedTextField(
            ...
            modifier = Modifier.fillMaxWidth(),
            isError = !itemDetails.isSupplierEmailValid && itemDetails.supplierEmail.isNotBlank(),
            enabled = enabled,
            singleLine = true
        )
        if (enabled) {
